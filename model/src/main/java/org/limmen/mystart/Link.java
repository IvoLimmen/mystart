...
public class Link extends BaseObject implements Comparable<Link> {
  ...
  public String getFormattedCreationDate() {
    return DateTimeFormatter.ofPattern("yyyy-MM-dd").format(this.getCreationDate());
  }
  ...
  public String getFormattedLastCheckDate() {
    ...
    return DateTimeFormatter.ofPattern("yyyy-MM-dd").format(this.getLastCheck());
  }
  ...
  public boolean hasKeyword(String keyword) {
    ...
    return (getUrl() != null && getUrl().toLowerCase().contains(keyword))
        ...
        || (getDescription() != null && getDescription().toLowerCase().contains(keyword)) || hasKeywordInLabel(keyword);
  }
